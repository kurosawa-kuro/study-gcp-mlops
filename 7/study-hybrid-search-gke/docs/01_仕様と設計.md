...
- **前提知識**: Phase 5 (Vertex AI 基盤 + Feature Store + Vector Search 必須) + Phase 6 (Composer 本線 + PMLE 統合: BQML / Dataflow / TreeSHAP / Monitoring SLO + burn-rate / Composer-managed BQ monitoring query) を既習扱い
