...
| serving | GKE Autopilot | `search-api` / KServe 推論 Pod の実行基盤 | **¥120-200** |
| serving | Gateway / Load Balancer | GKE 入口 | **¥20-40** |
| serving | Vertex Vector Search | semantic 候補取得の serving index | **¥70-140** |
| serving | Vertex AI Feature Store / Feature Online Store | online feature fetch | **¥180-320** |
...
| orchestration 補助 | Cloud Scheduler / Eventarc / Cloud Functions v2 | smoke / 軽量代替 trigger 経路 | **¥10-30** |
