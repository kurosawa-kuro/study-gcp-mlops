...
RULES: dict[str, frozenset[str]] = {
    ...
    "app/ports/publisher.py": COMMON_ADAPTERS,
    "app/ports/retrain_queries.py": COMMON_ADAPTERS,
    "app/ports/training_job_runner.py": COMMON_ADAPTERS,
    "app/ports/cache_store.py": COMMON_ADAPTERS,
    "app/ports/lexical_search.py": COMMON_ADAPTERS,
    "app/ports/candidate_retriever.py": COMMON_ADAPTERS | frozenset({"lightgbm"}),
    "app/ports/model_store.py": COMMON_ADAPTERS | frozenset({"lightgbm"}),
    "app/services/retrain_policy.py": COMMON_ADAPTERS,
    "app/services/ranking.py": COMMON_ADAPTERS | frozenset({"sentence_transformers"}),
    "app/services/model_store.py": COMMON_ADAPTERS,
    "app/schemas/search.py": COMMON_ADAPTERS | frozenset({"lightgbm", "numpy"}),
    "app/api/middleware/request_logging.py": COMMON_ADAPTERS,
    "app/config.py": COMMON_ADAPTERS | frozenset({"lightgbm"}),
