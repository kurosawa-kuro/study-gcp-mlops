...
Thin wrappers that translate :class:`EmbedSettings` into the fully-qualified
table names expected by the ``common.adapters`` classes. The embedding-job
entrypoint injects these into the pure-logic orchestrator so unit tests can
swap them out.
"""
