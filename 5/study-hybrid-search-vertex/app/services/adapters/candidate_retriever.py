...
class BigQueryCandidateRetriever:
    ...
    Args:
        ...
        semantic: semantic search adapter. Default stays the Phase 5
            ``BigQuery VECTOR_SEARCH`` implementation so behavior is unchanged.
    """
    ...
    def retrieve(
        ...
        *,
        ...
        semantic_results = self._semantic.search(query_vector=query_vector, filters=filters, top_k=200)
