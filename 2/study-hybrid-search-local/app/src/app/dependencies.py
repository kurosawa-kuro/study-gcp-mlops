...
from pipelines.adapters.cache.redis_cache_adapter import RedisCacheAdapter
from pipelines.adapters.embeddings.me5_embedding_adapter import ME5EmbeddingAdapter
from pipelines.adapters.persistence.feedback_repository_adapter import (
    FeedbackRepositoryAdapter,
)
from pipelines.adapters.persistence.ranking_compare_repository_adapter import (
    RankingCompareRepositoryAdapter,
)
from pipelines.adapters.persistence.search_log_repository_adapter import (
    SearchLogRepositoryAdapter,
)
from pipelines.adapters.ranking.lgbm_reranking_adapter import LightGBMRerankingAdapter
from pipelines.adapters.search.meilisearch_property_search_adapter import (
