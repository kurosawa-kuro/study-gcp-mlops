...
- Phase 6 は不動産検索ドメインから離れ、**GCP Professional Machine Learning Engineer 認定相当の総仕上げ** として独立させる
...
| 6 | `6/study-gcp-ml-engineer-cert/` | GCP ML Engineer 認定相当の総仕上げ | PMLE 試験範囲の整理、設計判断、MLOps、Responsible AI、GenAI/RAG、監視、コスト・運用判断 | Vertex AI, BigQuery ML, Dataflow, Model Garden, Agent Builder, Monitoring | ドキュメント + 小規模ハンズオン |
| 7 (Optional/Advanced) | `7/study-hybrid-search-gke/` | GKE/KServe 差分移行（Draft） | serving 層を GKE + KServe へ置換し、Phase 5 の学習/データ基盤を維持 | GKE, KServe, Gateway API, Workload Identity | uv + GKE/KServe |
...
- **GCP ML Engineer 認定相当の総仕上げ**: Phase 6（前提: **Phase 4/5 の GCP / Vertex 構成理解**）
