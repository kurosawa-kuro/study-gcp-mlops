...
| 7 | `7/study-hybrid-search-gke/` | GKE/KServe 差分移行（Draft） | Phase 6 の serving 層のみを GKE + KServe へ置換。Kubernetes 運用論点は抑え、まず動かす | GKE Autopilot, KServe, Gateway API, Workload Identity | uv + GKE Autopilot/KServe |
