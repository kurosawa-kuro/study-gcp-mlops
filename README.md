...
| 8 | `8/study-hybrid-search-gitops/` | Kubernetes 運用 / GitOps ラボ | Phase 7 の構成を GKE Standard + Argo CD 管理へ発展。NodePool / autoscaling / GitOps / sync / rollback / drift 管理を学ぶ | GKE Standard, Argo CD, KServe, Gateway API, Workload Identity, Terraform | uv + GKE Standard + Argo CD |
