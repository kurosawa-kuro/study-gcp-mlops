...
| 7 | `7/study-hybrid-search-gke/` | 不動産検索 (GKE + KServe, 到達ゴール) | **Phase 6 の serving 層のみ** を GKE Deployment + KServe InferenceService に差し替え (Pipelines / **Vertex AI Feature Store (Feature Group / Feature View / Feature Online Store)** / **Vertex Vector Search** / **Cloud Composer orchestration (Phase 5 → 6 → 7 と継承)** / Model Registry / BigQuery / Meilisearch は Phase 6 から継承。Feature Online Store は Phase 5 構築済を KServe から参照) |
