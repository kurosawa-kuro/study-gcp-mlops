...
the active Terraform environment directory so the follow-up
`terraform apply tfplan` is reproducible.
...
def main() -> int:
    ...
    print("==> Plan saved to infra/terraform/environments/main/tfplan.")
    return 0
