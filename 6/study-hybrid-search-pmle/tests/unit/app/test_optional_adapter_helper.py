...
(``build_popularity_scorer``). These tests keep the three observable
behaviours in place so a future refactor cannot silently start raising
on disabled flags or swallow the wrong exception class.
"""
