...
- **Phase 6 PMLE 技術 (BQML / Dataflow / Monitoring SLO + 補助 Explainable AI / Feature Group) を完全継承**。Serving 層のみ GKE + KServe に差し替え。親 README §1 教材対象外と全 Phase 禁止技術 (Vertex Vector Search / Agent Builder / Gemini RAG / Model Garden / Vizier / W&B / Looker Studio / Doppler) は本リポでも一切扱わない
